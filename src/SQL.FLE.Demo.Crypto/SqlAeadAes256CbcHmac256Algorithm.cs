...
namespace Microsoft.Data.SqlClient
{
    ...
    /// </summary>
    public class SqlAeadAes256CbcHmac256Algorithm : SqlClientEncryptionAlgorithm
    {
        /// <summary>
        /// Algorithm Name
        /// </summary>
        ...
        /// Algorithm version
        /// </param>
        public SqlAeadAes256CbcHmac256Algorithm(SqlAeadAes256CbcHmac256EncryptionKey encryptionKey, SqlClientEncryptionType encryptionType, byte algorithmVersion)
        {
        ...
        protected byte[] DecryptData(byte[] cipherText, bool hasAuthenticationTag)
        {
            ...
            if (cipherText[startIndex] != _algorithmVersion)
            {
                ...
                throw new Exception("Invalid algorithm version");
            }
