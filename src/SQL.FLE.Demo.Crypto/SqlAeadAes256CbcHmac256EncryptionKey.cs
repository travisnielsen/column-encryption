...
namespace Microsoft.Data.SqlClient
{
    ...
    /// </summary>
    public class SqlAeadAes256CbcHmac256EncryptionKey : SqlClientSymmetricKey
    {
        /// <summary>
        /// Key size in bits
        /// </summary>
        ...
        public SqlAeadAes256CbcHmac256EncryptionKey(byte[] rootKey, string algorithmName) : base(rootKey)
        {
            ...
            {
                // throw SQL.InvalidKeySize(_algorithmName, rootKey.Length, keySizeInBytes);
                throw new System.Exception("invalid key size");
            }
